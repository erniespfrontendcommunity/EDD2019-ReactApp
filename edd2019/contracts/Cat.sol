...
contract Cat is ERC721Full{
    ...
    function getCatAttributes(uint256 catId) public view returns(string memory catName, int stealth, int dexterity, int intelligence, int cuteness, int evilness, ChaosLevels chaosLevel){
